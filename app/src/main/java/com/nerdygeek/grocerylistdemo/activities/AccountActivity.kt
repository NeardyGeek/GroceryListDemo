...
class AccountActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        generateData(addressRowAdapter, user)

        account_recycler_view.adapter = addressRowAdapter
        account_recycler_view.layoutManager = LinearLayoutManager(this)
    ...
    private fun generateData(addressRowAdapter: AddressRowAdapter, user: User){
